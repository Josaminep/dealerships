...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_product'])) {
    ...
    // Inserting product into products5 table
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_stock'])) {
    ...
    // Updating stock in products5 table
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['modify_price'])) {
    ...
    // Updating price in products5 table
            ...
            <select name="product_id" required>
                <?php foreach ($products as $product): ?>
                    <option value="<?php echo $product['id5']; ?>">
                        <?php echo $product['product_name5'] . " (Current Stock: " . $product['stock5'] . ")"; ?>
                    </option>
                <?php endforeach; ?>
            </select>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            <select name="product_id" required>
                <?php foreach ($products as $product): ?>
                    <option value="<?php echo $product['id5']; ?>">
                        <?php echo $product['product_name5'] . " (Current Price: Php" . number_format($product['price5'], 2) . ")"; ?>
                    </option>
                <?php endforeach; ?>
            </select>

            ...
            <?php else: ?>
                <?php foreach ($sales as $sale): ?>
                    <tr id="row_<?php echo htmlspecialchars($sale['id']); ?>">
                        ...
                        <td>
                            <button type="button" class="accept-button" style="background-color: green; color: white;" onclick="printReceipt(<?php echo htmlspecialchars($sale['id']); ?>)">Print Receipt</button>
                            <button type="button" class="done-button" style="background-color: red; color: white;" onclick="markAsDone(<?php echo htmlspecialchars($sale['id']); ?>)">Done</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
